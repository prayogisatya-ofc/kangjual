    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="max-w-screen-xl xl:px-0 px-4 py-16 mx-auto">
            <div class="max-w-screen-md mb-8 lg:mb-16 mx-auto">
                <h2 class="mb-4 text-4xl text-center tracking-tight font-extrabold text-gray-900 dark:text-white">Project</h2>
                <p class="text-gray-500 font-light text-center sm:text-xl dark:text-gray-400">Kami menyediakan berbagai source code proyek dan aplikasi jadi yang siap untuk digunakan.</p>
            </div>
